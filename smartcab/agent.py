...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
        ...
        # Here we need to store a t parameter to remind what trial is being run
        # (Used in the advanced decaying functions)
        self.t = 0
    ...
    def reset(self, destination=None, testing=False):
        ...
        # self.epsilon = 1.0 * math.exp(-0.9 * self.t)
        self.epsilon = math.fabs(1.0 * math.cos(0.9 * self.t))
...
=======
        ...
        # Set 'state' as a tuple of relevant data for the agent        
        state = None
>>>>>>> cfe636963cdfe661136451f397b001c5597a4710
...
<<<<<<< HEAD
        if not self.learning:
            ...
            # Otherwise, choose an action with the highest Q-value for the current state
                ...
                action = random.choice([k for k in self.Q[state].keys() if self.Q[state][k] == maxQ])
